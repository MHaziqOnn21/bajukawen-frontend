...
export default function VendorAuth() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-baju-soft to-baju-background p-4">
        ...
        <Card className="w-full max-w-md bg-white border border-baju-input-border shadow-md">
          <CardContent className="p-6">
            <Tabs
              ...
              className="w-full"
            >
              <TabsList className="w-full bg-baju-background/50 border-b border-baju-input-border mb-6">
                <TabsTrigger
                  value="login"
                  className="flex-1 text-baju-subtext data-[state=active]:text-baju-heading data-[state=active]:border-b-2 data-[state=active]:border-baju-primary rounded-none"
                >
                  Login
                </TabsTrigger>
                <TabsTrigger
                ...
                <form className="space-y-4" onSubmit={handleLogin}>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-baju-input-border text-baju-text focus:border-baju-input-focus"
                      required
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-gradient-to-r from-baju-primary to-baju-secondary hover:bg-baju-secondary text-white border-none"
                  >
                    Login as Vendor
                  </Button>
                ...
                <form className="space-y-4" onSubmit={handleSignup}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-baju-input-border text-baju-text focus:border-baju-input-focus mb-2"
                      required
                    />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <Input
                        ...
                        className="border-baju-input-border text-baju-text bg-baju-background/50"
                        readOnly
                      />
                    </div>
    ...
    <Card className="w-full max-w-2xl bg-white border border-baju-input-border shadow-md">
      <CardContent className="p-6">
        ...
        <div className="max-h-[400px] overflow-y-auto mb-4 p-4 border border-baju-input-border rounded-md bg-baju-background/30 text-left">
          <h3 className="font-semibold mb-2 text-baju-heading">1. ACCEPTANCE OF TERMS</h3>
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">2. VENDOR RESPONSIBILITIES</h3>
          <p className="mb-3 text-baju-text">
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">3. FEES AND PAYMENTS</h3>
          <p className="mb-3 text-baju-text">
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">4. ACCOUNT MANAGEMENT</h3>
          <p className="mb-3 text-baju-text">
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">5. INTELLECTUAL PROPERTY</h3>
          <p className="mb-3 text-baju-text">
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">6. LIMITATION OF LIABILITY</h3>
          <p className="mb-3 text-baju-text">
          ...
          <h3 className="font-semibold mb-2 text-baju-heading">7. GOVERNING LAW</h3>
          <p className="mb-3 text-baju-text">
            These terms are governed by the laws of Malaysia without regard to its conflict of law provisions.
          </p>
          
          <h3 className="font-semibold mb-2 text-baju-heading">8. MODIFICATIONS TO TERMS</h3>
        ...
        <div className="flex space-x-4 justify-end">
          <Button 
            variant="outline" 
            onClick={onCancel}
            className="border-baju-primary text-baju-heading hover:bg-baju-soft/50"
          >
            Cancel
          </Button>
          <Button 
            onClick={onAccept}
            className="bg-gradient-to-r from-baju-primary to-baju-secondary hover:bg-baju-secondary text-white border-none"
          >
            I Accept
          </Button>
        </div>
